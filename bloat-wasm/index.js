...
// include: /var/folders/k5/8k421byx6bbdhf4hdh2l5tm40000gn/T/tmpi78x_c0j.js
...
// end include: /var/folders/k5/8k421byx6bbdhf4hdh2l5tm40000gn/T/tmpi78x_c0j.js
// include: /var/folders/k5/8k421byx6bbdhf4hdh2l5tm40000gn/T/tmpksvvc_1t.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/k5/8k421byx6bbdhf4hdh2l5tm40000gn/T/tmpksvvc_1t.js
// include: /var/folders/k5/8k421byx6bbdhf4hdh2l5tm40000gn/T/tmp2hu3lip0.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/k5/8k421byx6bbdhf4hdh2l5tm40000gn/T/tmp2hu3lip0.js
...
var ASM_CONSTS = {
  133094: () => { if (document.fullscreenElement) return 1; },  
 133140: () => { return Module.canvas.width; },  
 133172: () => { return parseInt(Module.canvas.style.width); },  
 133220: () => { document.exitFullscreen(); },  
 133247: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 133319: () => { if (document.fullscreenElement) return 1; },  
 133365: () => { return Module.canvas.width; },  
 133397: () => { return screen.width; },  
 133422: () => { document.exitFullscreen(); },  
 133449: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 133643: () => { return window.innerWidth; },  
 133669: () => { return window.innerHeight; },  
 133696: () => { if (document.fullscreenElement) return 1; },  
 133742: () => { return Module.canvas.width; },  
 133774: () => { return parseInt(Module.canvas.style.width); },  
 133822: () => { if (document.fullscreenElement) return 1; },  
 133868: () => { return Module.canvas.width; },  
 133900: () => { return screen.width; },  
 133925: () => { return window.innerWidth; },  
 133951: () => { return window.innerHeight; },  
 133978: () => { if (document.fullscreenElement) return 1; },  
 134024: () => { return Module.canvas.width; },  
 134056: () => { return screen.width; },  
 134081: () => { document.exitFullscreen(); },  
 134108: () => { if (document.fullscreenElement) return 1; },  
 134154: () => { return Module.canvas.width; },  
 134186: () => { return parseInt(Module.canvas.style.width); },  
 134234: () => { document.exitFullscreen(); },  
 134261: ($0) => { Module.canvas.style.opacity = $0; },  
 134299: () => { return screen.width; },  
 134324: () => { return screen.height; },  
 134350: () => { return window.screenX; },  
 134377: () => { return window.screenY; },  
 134404: () => { return window.devicePixelRatio; },  
 134440: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 134493: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 134544: () => { Module.canvas.style.cursor = 'none'; },  
 134581: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 134837: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 134888: () => { if (document.pointerLockElement) return 1; },  
 134935: () => { if (document.fullscreenElement) return 1; },  
 134981: () => { return window.innerWidth; },  
 135007: () => { return window.innerHeight; },  
